...
function CompanyList() {
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold">Tous</h2>
        <Link 
          href="#" 
          className="text-[#FF6B2C] flex items-center hover:underline"
        >
  ...
  <div className="w-full flex justify-end">
    <button className="bg-[#FF6B2C] text-white px-6 py-2 rounded hover:bg-[#ff5a13] transition-colors">
      Contacter/s'avérer
    </button>
  </div>
  
  {/* Product Images Grid - Responsive Layout */}
  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-2 w-full">
